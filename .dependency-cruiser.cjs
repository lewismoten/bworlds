...
const noDeprecatedCore = require("./node_modules/dependency-cruiser/configs/rules/no-deprecated-core.cjs");
const noDuplicateDependencyTypes = require("./node_modules/dependency-cruiser/configs/rules/no-duplicate-dependency-types.cjs");
const noNonPackageJson = require("./node_modules/dependency-cruiser/configs/rules/no-non-package-json.cjs");
const notToDeprecated = require("./node_modules/dependency-cruiser/configs/rules/not-to-deprecated.cjs");
