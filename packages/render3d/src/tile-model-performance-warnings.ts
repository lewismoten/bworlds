...
const FULL_DETAIL_DRAW_CALL_WARNING_MIN_DRAW_CALLS = 40;
...
const LOW_DETAIL_MATERIAL_GROUP_WARNING_MIN_GROUPS = 4;
...
const FULL_DETAIL_INSTANCING_WARNING_MIN_MESHES = 18;
const LOW_DETAIL_INSTANCING_WARNING_MIN_MESHES = 6;
const FULL_DETAIL_INSTANCING_WARNING_MIN_SHARED_GEOMETRY = 10;
const LOW_DETAIL_INSTANCING_WARNING_MIN_SHARED_GEOMETRY = 3;
const FULL_DETAIL_INSTANCING_WARNING_MIN_RENDERABLES = 18;
