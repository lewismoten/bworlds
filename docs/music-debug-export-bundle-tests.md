...
- [music-debug-export-bundle-archive.long.test.ts](/Users/lewismoten/dev/bworlds/apps/web/src/music-debug-export-bundle-archive.long.test.ts:1)
  covers ZIP contents and report payload assertions.
- [music-debug-export-bundle-download.long.test.ts](/Users/lewismoten/dev/bworlds/apps/web/src/music-debug-export-bundle-download.long.test.ts:1)
  covers blob download wiring.
- [music-debug-export-bundle-metrics.long.test.ts](/Users/lewismoten/dev/bworlds/apps/web/src/music-debug-export-bundle-metrics.long.test.ts:1)
  covers measured export timings and preview WAV counts.
- [music-debug-export-bundle-fallback.long.test.ts](/Users/lewismoten/dev/bworlds/apps/web/src/music-debug-export-bundle-fallback.long.test.ts:1)
