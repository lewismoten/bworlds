...
- [apps/web/src/sound-bank-debug-shell-options.test.ts](/Users/lewismoten/dev/bworlds/apps/web/src/sound-bank-debug-shell-options.test.ts)
  covers option normalization and seed randomization helpers.
- [apps/web/src/sound-bank-debug-shell-markup.test.ts](/Users/lewismoten/dev/bworlds/apps/web/src/sound-bank-debug-shell-markup.test.ts)
  covers the main browser shell markup, layout toggles, and patch-variant rendering.
- [apps/web/src/sound-bank-debug-shell-audio.test.ts](/Users/lewismoten/dev/bworlds/apps/web/src/sound-bank-debug-shell-audio.test.ts)
