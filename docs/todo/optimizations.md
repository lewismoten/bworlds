...
- [x] Avoid creating closures inside frequently executed loops.
- [x] Avoid string construction inside hot loops.
...
- [x] Warn when active audio sources exceed the budget.
...
That means you can afford **better rocks, sharper shadows, dripping water, stalactites, mine supports, bridges, rails and detailed props near the player** while potentially rendering _less_ geometry than an outdoor scene.
