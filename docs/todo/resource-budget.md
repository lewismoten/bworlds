...
* [ ] Record budget violations by plugin.
* [ ] Expose budget violations in the developer HUD.
...
* [ ] Cap draw calls per model.
* [ ] Cap draw calls per tile.
* [ ] Cap draw calls per chunk.
* [ ] Cap total scene draw calls.
* [ ] Count each material group as a potential draw call.
...
* [ ] Dispose rejected materials immediately.
* [ ] Dispose no-longer-used plugin-generated materials safely.
