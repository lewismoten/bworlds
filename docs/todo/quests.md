...
Quests should be setup as indivual plugins for each type, and support procedural generation based on resources available, or to place resources nearby for availability.
