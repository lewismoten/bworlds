...
That is probably the design I'd favor: the HUD tells you _something is wrong_; the debug snapshot gives you enough information to determine **what, where, and which plugin caused it**.
