...
- [ ] Reduce Object3D count and unnecessary scene hierarchy depth.
      ...
      now collapse their repeated tower bodies, caps, gate posts, and tower
      beacon braziers into instanced sets, and `tile-ruins` now collapses its
      repeated rubble fragments into one `InstancedMesh`, its repeated column
...
- [ ] Instance repeated trees, foliage, rocks, and other static props.
      ...
      tower bodies, caps, gate posts, and tower beacon braziers instead of
