...
- [ ] Reduce Object3D count and unnecessary scene hierarchy depth.
      ...
      repeated rails and support piles into shared `InstancedMesh` sets, and
      forest log bridges now collapse their repeated support posts into one
      shared `InstancedMesh`, which removes small clusters of redundant
...
- [ ] Instance repeated trees, foliage, rocks, and other static props.
      ...
      and forest log bridges now instance their repeated support posts
