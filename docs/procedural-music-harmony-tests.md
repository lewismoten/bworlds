...
- [procedural-music-harmony-chords.long.test.ts](/Users/lewismoten/dev/bworlds/apps/web/src/procedural-music-harmony-chords.long.test.ts:1)
  covers progression resolution, bass figures, cadence state, and shared chord
  context reuse.
- [procedural-music-harmony-lead.long.test.ts](/Users/lewismoten/dev/bworlds/apps/web/src/procedural-music-harmony-lead.long.test.ts:1)
  covers lead-note motion, contour ranges, climax placement, and accidental
  limits across sampled phrases.
- [procedural-music-harmony-voicing.long.test.ts](/Users/lewismoten/dev/bworlds/apps/web/src/procedural-music-harmony-voicing.long.test.ts:1)
