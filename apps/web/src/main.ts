...
function collectCurrentDebugSnapshot(
  ...
  const debugSnapshot: DebugSnapshot = {
    ...
    materialCount: rendererStats.materialCount,
    materialCacheHitCount: rendererStats.materialCacheHitCount,
    materialCacheMissCount: rendererStats.materialCacheMissCount,
    materialCacheHitRate: rendererStats.materialCacheHitRate,
    ...
    geometryCacheHitCount: rendererStats.geometryCacheHitCount,
    geometryCacheMissCount: rendererStats.geometryCacheMissCount,
    geometryCacheHitRate: rendererStats.geometryCacheHitRate,
  ...
  debugSnapshot.resourceWarnings = [
    ...
    ...getLodSwapWarnings(debugSnapshot),
...
function render(): FrameLoopActivityLike {
  ...
  if (sextantSummary && sextantInspectorVisible && gps) {
    ...
    const terrainTileDebugInfo = renderer3d.getVisibleTileDebugInfo(
      gridX,
      gridY
    );
    const terrainHeight =
      ...
      Number.isFinite(spatial.tile.surfaceHeight)
        ...
        : null;
    const terrainLod =
      terrainTileDebugInfo?.renderedDetailLevel ??
