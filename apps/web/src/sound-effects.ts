...
export function getAmbientSoundCadenceMs(
  ...
  switch (kind) {
    ...
    case 'desert':
      return Math.round(clampValue(3520 - clamped * 980, 2000, 3520));
    case 'snowfield':
      return Math.round(clampValue(3800 - clamped * 900, 2200, 3800));
    case 'swamp':
      return Math.round(clampValue(3100 - clamped * 1000, 1700, 3100));
    case 'volcanic':
...
export function resolveAmbientSoundFrequency(
  ...
  switch (kind) {
    ...
    case 'desert':
      return 148 + clamped * 16;
    case 'snowfield':
      return 132 + clamped * 14;
    case 'swamp':
      return 154 + clamped * 18;
    case 'volcanic':
...
export function getAmbientSoundDurationMs(
  ...
  switch (kind) {
    ...
    case 'desert':
      return Math.round(clampValue(1460 + clamped * 380, 1460, 1840));
    case 'snowfield':
