...
describe('root entry route', () => {
  ...
  it('resolves dedicated debug pages and leaves the game route alone', () => {
    ...
    expect(resolveRootEntryPagePath('/debug/ambience')).toBe(
      '/debug/ambience/'
    );
    expect(resolveRootEntryPagePath('/debug/ambience/')).toBe(
      '/debug/ambience/'
    );
    expect(resolveRootEntryPagePath('/debug/ambience.html')).toBe(
      '/debug/ambience/'
    );
    expect(resolveRootEntryPagePath('/debug/ambience/index.html')).toBe(
      '/debug/ambience/'
    );
  ...
  it('resolves debug routes mounted under a base path without losing their logical page', () => {
    ...
    expect(resolveRootEntryPagePath('/bworlds/debug/ambience/')).toBe(
      '/debug/ambience/'
    );
  ...
  it('resolves dedicated debug html entry files for canonical routes', () => {
    ...
    expect(resolveRootEntryHtmlPath('/debug/ambience/')).toBe(
