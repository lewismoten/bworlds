export const LONG_TEST_FILES = [
  ...
  'apps/web/src/music-debug-midi-export.test.ts',
  'apps/web/src/music-debug-midi-interaction.test.ts',
  'apps/web/src/music-debug-midi-validation.test.ts',
  ...
  'apps/web/src/music-debug-snapshot.test.ts',
  ...
  'apps/web/src/procedural-music-song-arrangement.test.ts',
  'apps/web/src/procedural-music-song-phrasing.test.ts',
  'apps/web/src/procedural-music-song-structure.test.ts',
